...
- [x] Buat halaman dashboard `/admin/dashboard` (ref: PRD Bab 16.6)
- [x] Proteksi route: redirect ke login jika belum auth (ref: PRD Bab 23)
- [x] Tabel daftar submission (nama, tanggal, jenis, hasil ringkas) (ref: PRD Bab 16.6, 18)
- [x] Filter: jenis assessment, rentang tanggal, jenis rekomendasi (ref: PRD Bab 18)
- [x] Search: nama/nomor kontak (ref: PRD Bab 18)
- [x] Sorting: tanggal (default terbaru), skor (ref: PRD Bab 18)
- [x] Pagination: 20-25 baris/halaman (ref: PRD Bab 18)
- [x] Responsive: tabel → card list di mobile (ref: PRD Bab 19)
