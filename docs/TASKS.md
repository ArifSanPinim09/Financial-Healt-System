...
- [x] Implementasi round-robin: last_used_index % j//umlah_cs_aktif (ref: PRD Bab 12.7, F6)
...
- [x] Audit kontras warna (WCAG AA) (ref: PRD Bab 21)
- [x] Keyboard navigation untuk opsi jawaban (ref: PRD Bab 21)
- [x] Label form terhubung ke input (ref: PRD Bab 21)
- [x] Target area tap minimal 44x44px (ref: PRD Bab 21)
- [x] Font body minimal 16px (ref: PRD Bab 21)
- [x] Error indication tidak hanya warna (tambah icon/teks) (ref: PRD Bab 21)
- [x] Mobile: sticky button "Lanjut" di bawah (ref: PRD Bab 19)
- [x] Mobile: filter dashboard di bottom sheet/modal (ref: PRD Bab 19)
...
*Terakhir diupdate: 2026-08-30 (Modul 16 selesai)*
