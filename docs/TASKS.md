...
- [ ] Buat tabel `question_option` (ref: PRD Bab 12.2)
- [ ] Buat tabel `submission` dengan index unique (customer_phone, assessment_type) (ref: PRD Bab 12.3, F14)
- [ ] Buat tabel `submission_answer` (ref: PRD Bab 12.4)
- [ ] Buat tabel `dimension_result` (ref: PRD Bab 12.5)
- [ ] Buat tabel `admin_profile` (FK ke auth.users) (ref: PRD Bab 12.6)
- [ ] Buat tabel `cs_contact` dengan field round-robin (ref: PRD Bab 12.7)
- [ ] Buat tabel `cs_rotation_state` untuk counter round-robin (ref: PRD Bab 12.7)
- [ ] Buat tabel `submission_audit_log` (ref: PRD Bab 25)
- [ ] Seed data `question_bank` + `question_option` untuk Financial Rating (Q1-Q14) (ref: PRD Bab 31)
- [ ] Seed data `question_bank` + `question_option` untuk Financial Needs (Q1-Q10) (ref: PRD Bab 31)
- [ ] Seed placeholder data `cs_contact` (3 nomor CS) (ref: PRD Bab 12.7, 29)
- [ ] Setup RLS: question_bank/option = read-only publik (ref: PRD Bab 23)
- [ ] Setup RLS: submission = insert-only publik, read untuk authenticated (ref: PRD Bab 23)
- [ ] Setup RLS: submission_answer, dimension_result = read untuk authenticated (ref: PRD Bab 23)
- [ ] Setup Supabase Auth untuk 1 akun admin (ref: PRD Bab 5.1, F11)
- [ ] Generate TypeScript types dari schema (ref: PRD Bab 5.2)
